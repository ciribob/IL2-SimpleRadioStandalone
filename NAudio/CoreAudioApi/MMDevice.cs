...
namespace NAudio.CoreAudioApi
{
    ...
    public class MMDevice : IDisposable
    {
        ...
        {
            object result;
            Marshal.ThrowExceptionForHR(deviceInterface.Activate(ref IID_IAudioMeterInformation, ClsCtx.ALL,
        ...
        {
            object result;
            Marshal.ThrowExceptionForHR(deviceInterface.Activate(ref IDD_IAudioSessionManager, ClsCtx.ALL, IntPtr.Zero,
                out result));
